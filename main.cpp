...
int main() {
    ...
    for(int i=0; i<len; i++) {          
        ...
        std::cout<< size
                 << std::setw(20) << sortTime(iArray, size, 'i') << std::setw(15) << sortTime(sArray, size, 's') 
                 << std::setw(15) << sortTime(bArray, size, 'b') << std::setw(15) << sortTime(hArray, size, 'h') 
                 << std::setw(15) << sortTime(qArray, size, 'q') << std::setw(15) << sortTime(mArray, size, 'm') << std::endl;
